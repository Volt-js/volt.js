# Using Claude with Volt.js

Claude, by Anthropic, is a powerful family of large language models that can be used as an effective code agent for developing Volt.js applications. Its strong reasoning and code generation capabilities make it a great assistant for writing, reviewing, and maintaining your projects.
...
## Method 1: Training Claude on the Volt.js Framework

This method gives Claude a deep, foundational understanding of the entire Volt.js framework by pointing it to our official, comprehensive documentation file. This is ideal when working on an existing project that wasn't created from one of our templates.
