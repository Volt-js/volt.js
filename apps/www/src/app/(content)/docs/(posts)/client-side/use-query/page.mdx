...
The `useQuery` hook is the primary tool for fetching data from your Volt.js backend in a client-side React component. It is a **completely custom implementation** built from scratch specifically for Volt.js, providing a familiar and powerful API with a crucial advantage: it's **end-to-end type-safe**.
