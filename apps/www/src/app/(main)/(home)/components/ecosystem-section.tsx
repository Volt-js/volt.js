...
const starterKits = [
  {
    ...
    description: "Full-stack Next.js application with Volt.js backend",
    icon: (
      <svg className="w-12 h-12" viewBox="0 0 50 50" fill="none">
  ...
  },
  {
    ...
    description: "Traditional Express.js REST API with Volt.js",
    icon: (
      <svg className="w-12 h-12" viewBox="0 0 50 50" fill="none">
        <rect width="50" height="50" rx="8" fill="#000000"/>
...
const products = [
  ...
  {
    name: "Volt Studio",
    description: "Visual development environment for Volt.js applications",
    status: "coming-soon",
    link: "#"
  },
  {
