...
>
  <ul className="list-disc pl-5 mt-4 space-y-2">
    ...
    <li>
      **CLI Update:** The `volt init` command was updated to download starter templates directly from the official GitHub repository, ensuring users always get the latest version.
    </li>
    <li>
...
>
  <ul className="list-disc pl-5 mt-4 space-y-2">
    <li>
      **New: MCP Server Adapter:** Shipped the first version of `@volt.js/adapter-mcp-server`, allowing AI agents to use Volt.js APIs as a set of tools.
    </li>
    <li>
