...
Built with @voltjs and an amazing stack: ${stackNames}
            ...
            <div className="relative">
              ...
              {isStarter && (
                <section className="relative">
                  ...
                  <div className="ml-12 space-y-6">
                    <div>
                      <h3 className="text-sm">Volt.js Features</h3>
                    </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            onClick={() => {
                              const text = encodeURIComponent(generateSocialPost());
                              window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://voltjs.dev')}&summary=${text}`, '_blank');
                            }}
                            size="sm"
                            variant="outline"
                            className="rounded-full w-fit"
                  ...
                  <section className="relative">
                    ...
                    <div className="ml-12 space-y-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <Button
                          onClick={() => {
                            window.open('https://github.com/Volt-js/volt.js', '_blank');
                          }}
                          size="sm"
                          variant="outline"
                          className="rounded-full w-fit"
                        ...
                        <Button
                          onClick={() => {
                            window.open('https://voltjs.dev/docs', '_blank');
                          }}
                          size="sm"
                          variant="outline"
                          className="rounded-full w-fit"
                        ...
                        <Button
                          onClick={() => {
                            window.open('https://voltjs.dev/examples', '_blank');
                          }}
                          size="sm"
                          variant="outline"
                          className="rounded-full w-fit"
                        ...
                        <Button
                          onClick={() => {
                            window.open('https://voltjs.dev/changelog', '_blank');
                          }}
                          size="sm"
                          variant="outline"
                          className="rounded-full w-fit"
