        ...
        <div className="container mx-auto max-w-screen-2xl">
          ...
          <div className='border-x border-border py-24 px-10'>
            ...
            <p className="text-muted-foreground max-w-md mb-5">
              Volt.js is a collection of templates that help you get started with web development. Whether you're building a personal blog, an e-commerce platform, or a complex web application, Volt.js has you covered.
            </p>
