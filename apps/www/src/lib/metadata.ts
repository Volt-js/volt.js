...
export function generateMetadata({
  ...
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://voltjs.dev';
...
export function generateBlogMetadata({
  ...
  return generateMetadata({
    ...
    author,
    section: 'Technology',
    keywords: [...keywords, 'Volt.js', 'TypeScript', 'Full-stack', 'Framework']
  });
}
...
export function generateDocsMetadata({
  ...
  return generateMetadata({
    ...
    description,
    canonical: `/docs/${slug}`,
    keywords: [...keywords, 'Volt.js', 'Documentation', 'TypeScript', 'API', 'Tutorial']
  });
}
