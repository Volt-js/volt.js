...
/**
 * OpenTelemetry Span wrapper that implements VoltTelemetrySpan interface
 */
export class OpenTelemetrySpanWrapper implements VoltTelemetrySpan {
  private _span: any;
  private _tracer: any;
 ...
 */
class NoOpSpan implements VoltTelemetrySpan {
  ...
  child(name: string): VoltTelemetrySpan {
    return new NoOpSpan(name);
  }
