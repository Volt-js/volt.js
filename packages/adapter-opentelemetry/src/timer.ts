...
/**
 * OpenTelemetry Timer wrapper that implements VoltTimer interface
 */
export class OpenTelemetryTimer implements VoltTimer {
 ...
 */
export class NoOpTimer implements VoltTimer {
