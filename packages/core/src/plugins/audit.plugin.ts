import { createVoltPlugin, createVoltPluginAction } from "../types/plugin.interface";
import { z } from "zod";
...
export const audit = createVoltPlugin<AuditContext>({
  name: "audit",
  $meta: {
    version: "1.0.0",
  ...
  $actions: {
    ...
    getUserLogs: createVoltPluginAction({
      name: "getUserLogs",
