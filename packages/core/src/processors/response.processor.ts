...
import type { VoltProcessorResponse, VoltErrorResponse, VoltCommonErrorCode } from "../types/response.interface"
...
/**
 * A builder class for creating and manipulating HTTP responses in the Volt Framework.
 ...
 * const response = VoltResponseProcessor.init<MyContext>()
 *   .status(200)
 *   .setCookie('session', 'abc123', { httpOnly: true })
 *   .success({ user: { id: 1, name: 'John' } }) // Now typed as VoltResponseProcessor<MyContext, { user: { id: number, name: string } }>
 *   .toResponse();
 * ```
 */
export class VoltResponseProcessor<TContext = unknown, TData = unknown> {
  ...
  private _store?: VoltStoreAdapter
  private _context?: TContext
  private _logger?: VoltLogger

  private get logger(): VoltLogger {
    if (!this._logger) {
  ...
  /**
   * Creates a new instance of VoltResponseProcessor.
   ...
   * @returns A new VoltResponseProcessor instance
   *
   * @example
   * ```typescript
   * const response = VoltResponseProcessor.init<MyContext>(store, context);
   * ```
   */
  static init<TContext = unknown>(
    store?: VoltStoreAdapter,
    context?: TContext
  ): VoltResponseProcessor<TContext, unknown> {
    const instance = new VoltResponseProcessor<TContext, unknown>();
   ...
   * @private
   */
  private withData<TNewData>(): VoltResponseProcessor<TContext, TNewData> {
    const newInstance = new VoltResponseProcessor<TContext, TNewData>();
  ...
  stream<TStreamData = ResponseData>(options: StreamOptions<TStreamData>) {
    ...
    const newInstance = this.withData<VoltProcessorResponse<TStreamData, null>>();
   ...
   * response.success(user); // Returns VoltResponseProcessor<TContext, typeof user>
   * ```
   */
  success<TSuccessData>(data?: TSuccessData) {
    const instance = this.withData<VoltProcessorResponse<TSuccessData, null>>()
    instance._response = {} as VoltProcessorResponse<TSuccessData, null>;
   ...
   * response.created(newUser); // Returns VoltResponseProcessor<TContext, typeof newUser>
   * ```
   */
  created<TCreatedData>(data: TCreatedData) {
    const instance = this.withData<VoltProcessorResponse<TCreatedData, null>>()
    instance._response = {} as VoltProcessorResponse<TCreatedData, null>;
   ...
   */
  noContent() {
    const instance = this.withData<VoltProcessorResponse<null, null>>()
    instance._response = {} as VoltProcessorResponse<null, null>;
  ...
  error<TErrorCode extends string, TData extends ResponseData>(error: {
    ...
    const instance = this.withData<VoltProcessorResponse<null, VoltErrorResponse<TErrorCode, TData>>>()
    instance._response = {} as VoltProcessorResponse<null, VoltErrorResponse<TErrorCode, TData>>;
    instance._response.data = null;
  ...
  badRequest<TBadRequestData>(message = 'Bad Request', data?: TBadRequestData) {
    const instance = this.withData<VoltProcessorResponse<null, VoltErrorResponse<'ERR_BAD_REQUEST', TBadRequestData>>>()
    instance._response = {} as VoltProcessorResponse<null, VoltErrorResponse<'ERR_BAD_REQUEST', TBadRequestData>>;
    instance._response.data = null;
    instance._response.error = {} as VoltErrorResponse<'ERR_BAD_REQUEST', TBadRequestData>;
  ...
  unauthorized<TUnauthorizedData>(message = 'Unauthorized', data?: TUnauthorizedData) {
    const instance = this.withData<VoltProcessorResponse<null, VoltErrorResponse<'ERR_UNAUTHORIZED', TUnauthorizedData>>>()
    instance._response = {} as VoltProcessorResponse<null, VoltErrorResponse<'ERR_UNAUTHORIZED', TUnauthorizedData>>;
    instance._response.data = null;
    instance._response.error = {} as VoltErrorResponse<'ERR_UNAUTHORIZED', TUnauthorizedData>;
    instance._response.error.message = message;
    instance._response.error.data = data;
  ...
  forbidden<TForbiddenData>(message = 'Forbidden', data?: TForbiddenData) {
    const instance = this.withData<VoltProcessorResponse<null, VoltErrorResponse<'ERR_FORBIDDEN', TForbiddenData>>>()
    instance._response = {} as VoltProcessorResponse<null, VoltErrorResponse<'ERR_FORBIDDEN', TForbiddenData>>;
    instance._response.data = null;
    instance._response.error = {} as VoltErrorResponse<'ERR_FORBIDDEN', TForbiddenData>;
    instance._response.error.message = message;
    instance._response.error.data = data;
  ...
  notFound<TNotFoundData>(message = 'Not Found', data?: TNotFoundData) {
    const instance = this.withData<VoltProcessorResponse<null, VoltErrorResponse<'ERR_NOT_FOUND', TNotFoundData>>>()
    instance._response = {} as VoltProcessorResponse<null, VoltErrorResponse<'ERR_NOT_FOUND', TNotFoundData>>;
    instance._response.data = null;
    instance._response.error = {} as VoltErrorResponse<'ERR_NOT_FOUND', TNotFoundData>;
    instance._response.error.message = message;
    instance._response.error.data = data;
  ...
  redirect(destination: string, type: 'replace' | 'push' = 'replace') {
    ...
    const instance = this.withData<VoltProcessorResponse<null, VoltErrorResponse<'ERR_REDIRECT', RedirectData>>>()
    instance._response = {} as VoltProcessorResponse<null, VoltErrorResponse<'ERR_REDIRECT', RedirectData>>;
    instance._response.data = null;
    instance._response.error = {} as VoltErrorResponse<'ERR_REDIRECT', RedirectData>;
   ...
   * response.json(result); // Returns VoltResponseProcessor<TContext, typeof result>
   * ```
   */
  json<TJsonData>(data: TJsonData) {
    const instance = this.withData<VoltProcessorResponse<TJsonData, null>>()
    instance._response = {} as VoltProcessorResponse<TJsonData, null>;
  ...
  private createStream(): Response {
    ...
    if (!SSEProcessor.channelExists(channelId)) {
      ...
      SSEProcessor.registerChannel({
        id: channelId,
        description: `Dynamic channel created by VoltResponseProcessor`
      });
    }
