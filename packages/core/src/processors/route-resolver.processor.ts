...
import { VoltLogLevel, type VoltAction, type VoltLogger } from "../types";
...
export interface RouteResult {
  success: boolean;
  action?: VoltAction<any, any, any, any, any, any, any, any, any, any>;
...
/**
 * Route resolver processor for the Volt Framework.
...
export class RouteResolverProcessor {
  ...
  static resolve(
    ...
    return {
      success: true,
      action: route.data as VoltAction<any, any, any, any, any, any, any, any, any, any>,
      params: finalParams
    };
  }
}
