...
describe('ErrorHandlerProcessor', () => {
  ...
  describe('handleError', () => {
    ...
    test('should handle VoltError', async () => {
      const Voltror = new VoltError({
        message: 'Not found',
        code: 'NOT_FOUND',
      });
  ...
  describe('handleVoltError', () => {
    test('should format VoltError response', async () => {
      const error = new VoltError({
      ...
      const context = createMockContext();
      const result = await ErrorHandlerProcessor['handleVoltError'](
        error,
        context,
        mockTelemetrySpan as any,
        Date.now()
