...
/**
 * Volt.js Client Interface Definitions
 *
 * This module contains all type definitions for the Volt.js client-side implementation.
 * The client is a completely custom implementation built from scratch specifically for Volt.js,
 * providing end-to-end type safety and seamless integration with the Volt.js backend.
 *
 * Key Features:
...
export type ClientConfig<TRouter extends VoltRouter<any, any, any, any, any>> = {
...
export type InferAllActionPaths<TRouter extends VoltRouter<any, any, any, any, any>> = {
...
export type InvalidateFunction<TRouter extends VoltRouter<any, any, any, any, any>> = {
...
export type InferRouterCaller<
  TRouter extends VoltRouter<any, any, any, any, any>,
> =
  TRouter extends VoltRouter<any, infer TControllers, any, any, any>
  ? {
