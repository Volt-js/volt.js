import type { VoltControllerConfig } from "./controller.interface";
import type { DocsConfig, VoltBaseConfig } from "./builder.interface";
...
export type VoltRouterCaller<
  TControllers extends Record<string, VoltControllerConfig<any>>, // ✅ Simplificado
> = {
...
> = {
  ...
  $context: TContext;
  $plugins: TPlugins;
  $caller: VoltRouterCaller<TControllers>;
}