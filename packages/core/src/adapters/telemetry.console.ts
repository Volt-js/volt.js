 ...
 */
class ConsoleTelemetrySpan implements VoltTelemetrySpan {
 ...
 */
class ConsoleTelemetryTimer implements VoltTimer {
  public readonly name: string;
  public readonly startTime: number;
 ...
 */
class ConsoleTelemetryProvider implements VoltTelemetryProvider {
  public readonly config: VoltTelemetryConfig;
  public readonly name = 'console';
  public readonly status: 'active' | 'inactive' | 'error' = 'active';

  private activeSpan: VoltTelemetrySpan | null = null;
  private spanStack: VoltTelemetrySpan[] = [];
  private store?: VoltStoreAdapter;
  private enableCliIntegration: boolean;
  private channel: string;
  private logger: VoltLogger = new VoltConsoleLogger({
    level: resolveLogLevel(),
    context: createLoggerContext('ConsoleTelemetryProvider')
  })

  constructor(
    config: VoltTelemetryConfig,
    ...
    this.channel = options.channel ?? 'volt:telemetry';
