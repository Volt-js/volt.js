...
describe('Realtime Service', () => {
  ...
  let realtimeService: VoltRealtimeService<TestContext>;
  ...
  beforeEach(() => {
    ...
    realtimeService = new VoltRealtimeService(mockStore);
  });

  describe('VoltRealtimeService Construction', () => {
    it('should create realtime service with store adapter', () => {
      expect(realtimeService).toBeInstanceOf(VoltRealtimeService);
    });
