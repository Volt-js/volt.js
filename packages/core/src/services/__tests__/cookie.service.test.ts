...
import { VoltCookie } from '../cookie.service';
...
describe('Cookie Service', () => {
  ...
  let cookies: VoltCookie;

  beforeEach(() => {
    vi.clearAllMocks();
    headers = new MockHeaders();
    cookies = new VoltCookie(headers as any);
  });

  describe('VoltCookie Construction', () => {
    it('should create cookie instance with empty headers', () => {
      const emptyHeaders = new MockHeaders();
      const emptyCookies = new VoltCookie(emptyHeaders as any);
    ...
    it('should parse existing cookies from headers', () => {
      ...
      const parsedCookies = new VoltCookie(headersWithCookies as any);
    ...
    it('should handle malformed cookie headers gracefully', () => {
      ...
      const parsedCookies = new VoltCookie(malformedHeaders as any);
    ...
    it('should handle empty cookie header', () => {
      ...
      const parsedCookies = new VoltCookie(emptyHeaders as any);
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle missing headers gracefully', () => {
      ...
      const nullCookies = new VoltCookie(nullHeaders as any);
