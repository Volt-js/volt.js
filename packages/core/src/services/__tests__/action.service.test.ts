...
import { createVoltQuery, createVoltMutation } from '../action.service';
import type { StandardSchemaV1, VoltProcedure } from '../../types';
...
const createMockProcedure = (name: string): VoltProcedure<any, any, any> => ({
  name,
...
describe('Action Service', () => {
  describe('createVoltQuery', () => {
    it('should create a query action with GET method', () => {
      const queryAction = createVoltQuery({
        path: 'users',
        handler: mockHandler,
      });
    ...
    it('should preserve all provided options', () => {
      ...
      const queryAction = createVoltQuery(options);
  ...
  describe('createVoltMutation', () => {
    it('should create a mutation action preserving the method', () => {
      const mutationAction = createVoltMutation({
        path: 'users',
        method: 'POST',
        handler: mockHandler,
      });
    ...
    it('should preserve all provided options including body and query', () => {
      ...
      const mutationAction = createVoltMutation(options);
  ...
  describe('Type Safety and Structure', () => {
    ...
    it('should handle minimal query configuration', () => {
      const minimalQuery = createVoltQuery({
        path: 'minimal',
        handler: vi.fn(),
      });
    ...
    it('should handle minimal mutation configuration', () => {
      const minimalMutation = createVoltMutation({
        path: 'minimal',
        method: 'POST',
        handler: vi.fn(),
      });
