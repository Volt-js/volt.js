...
import { createVoltJobsService, createJobDefinition, createJobsRouter } from '../jobs.service'
import type { VoltJobQueueAdapter, JobDefinition, JobsRouter } from '../../types/jobs.interface'
import { z } from 'zod'

// Mock adapter for testing
const createMockAdapter = (): VoltJobQueueAdapter<any> => ({
  client: {},
...
describe('Jobs Service', () => {
  let mockAdapter: VoltJobQueueAdapter<TestContext>
  ...
  describe('Service Creation', () => {
    test('should create jobs service with adapter and context factory', () => {
      const service = createVoltJobsService({
        adapter: mockAdapter,
        contextFactory
      })
