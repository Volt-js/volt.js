...
import { VoltResponseProcessor } from '../../processors/response.processor';
...
describe('Procedure Service - Legacy API', () => {
  describe('createVoltProcedure', () => {
    it('should create a basic procedure with legacy API', () => {
      const mockHandler = vi.fn().mockResolvedValue({ success: true });

      const procedureConfig: VoltProcedure<TestContext, undefined, { success: boolean }> = {
        name: 'test-procedure',
        handler: mockHandler
      };

      const procedureFactory = createVoltProcedure(procedureConfig);
    ...
    it('should create procedure with options', () => {
      ...
      const procedureConfig: VoltProcedure<TestContext, TestOptions, { configured: boolean }> = {
    ...
    it('should execute procedure handler with correct context', async () => {
      ...
      const procedureConfig: VoltProcedure<TestContext, { flag: boolean }, { executed: boolean }> = {
    ...
    it('should handle procedure without options', async () => {
      ...
      const procedureConfig: VoltProcedure<TestContext, undefined, { simple: boolean }> = {
    ...
    it('should handle synchronous procedure handlers', () => {
      ...
      const procedureConfig: VoltProcedure<TestContext, undefined, { sync: boolean }> = {
        name: 'sync-procedure',
        handler: mockHandler
      };
