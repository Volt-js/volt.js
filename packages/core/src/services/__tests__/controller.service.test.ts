...
describe('Controller Service', () => {
  describe('createVoltController', () => {
    it('should return the exact configuration passed to it', () => {
      ...
      // @ts-expect-error - Testing with simplified mock actions, not full VoltAction objects
      const controller = createVoltController(config);
  ...
  describe('Type Safety and Structure', () => {
    it('should maintain the exact structure of the input configuration', () => {
      ...
      const controller = createVoltController(originalConfig as any);
    ...
    it('should not modify the input configuration', () => {
      ...
      // @ts-expect-error - Testing with simplified mock actions, not full VoltAction objects
      const controller = createVoltController(originalConfig);
  ...
  describe('Edge Cases', () => {
    it('should handle null-like values in configuration', () => {
      ...
      const controller = createVoltController(config as any);
