...
<html>
  <head>
    <title>${docsConfig?.info?.title ?? 'Unnamed'} (${docsConfig?.info?.version ?? '1.0.0'}) - Volt Studio</title>
    <meta charset="utf-8" />
  ...
  <body>
    <header class="header">
      <img src="https://voltjs.com/logo-light.svg" alt="Volt Logo" />
      ...
      <div class="header-actions">
        <div class="social-links">
         ...
         <a href="https://voltjs.com" target="_blank" class="docs-link">
            <span>Powered By Volt.js</span>
...
class PlaygroundRequestHandler {
  ...
  async handle(request: Request, docsConfig?: DocsConfig, basePath?: string): Promise<Response> {
    try {
      ...
      logger.error('Error generating Volt Studio:', { error });
      return new Response('Internal Server Error', { status: 500 });
    }
  }
}

export function initializeVoltPlayground(docsConfig?: DocsConfig, basePath?: string): {
