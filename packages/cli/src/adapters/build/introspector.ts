 ...
 */
export function introspectRouter(router: VoltRouter<any, any, any, any, any>): { schema: IntrospectedRouter, stats: { controllers: number, actions: number } } {
 ...
 */
export async function loadRouter(routerPath: string): Promise<VoltRouter<any, any, any, any, any>> {
  ...
  try {
    ...
    throw new Error('Module was compiled and loaded, but no valid Volt router export was found.');
  } catch (error: any) {
