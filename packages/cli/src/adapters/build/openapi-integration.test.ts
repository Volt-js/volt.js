...
describe('OpenAPI Generator Integration - docs configuration', () => {
  it('should generate OpenAPI spec with docs configuration from router', () => {
      ...
      config: {
        ...
        docs: {
          info: {
            title: 'Test API',
            version: '1.0.0',
            description: 'A comprehensive test API for Volt.js',
          },
          servers: [
    ...
    } as VoltRouter<any, any, any, any, any>;
    ...
    expect(spec.info.description).toBe('A comprehensive test API for Volt.js');
  ...
  it('should handle missing docs configuration gracefully', () => {
    ...
    expect(spec.info.title).toBe('Volt API');
    expect(spec.info.version).toBe('1.0.0');
